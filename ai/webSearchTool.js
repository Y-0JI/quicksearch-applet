                ...
                if (Soup) {
                    try {
                        ...
                        if (!_setRequestBodyBoxedFree(msg, 'application/json', body)) {
                            const e = new Error('boxed-free request body unavailable');
                            e.code = 'backend_unavailable';
                            return cb(e);
                        }
